...
export default function Model({ ...props }) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/vincent.glb')
  const { actions } = useAnimations(animations, group)
  useEffect(()=>{
    //nodes.mixamorigHips.position.setScalar(0);
//materials.vincent_shoes.color=red
 materials.vincent_shoes.color={r:0,g:255,b:0}
//     actions.hello.play()
//     actions.hello.repetitions=1
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <group position={[-0.01, 0.01, 0]} rotation={[1.58, 0.02, -0.01]}>
        <mesh
      ...
      <skinnedMesh
        ...
        material={nodes['GEO-vincent_eyeball_R'].material}
      ...
      <skinnedMesh
        name="GEO-vincent_eyeball_L"
        geometry={nodes['GEO-vincent_eyeball_L'].geometry}
        material={nodes['GEO-vincent_eyeball_L'].material}
        skeleton={nodes['GEO-vincent_eyeball_L'].skeleton}
        morphTargetDictionary={nodes['GEO-vincent_eyeball_L'].morphTargetDictionary}
        morphTargetInfluences={nodes['GEO-vincent_eyeball_L'].morphTargetInfluences}>
        <skinnedMesh
